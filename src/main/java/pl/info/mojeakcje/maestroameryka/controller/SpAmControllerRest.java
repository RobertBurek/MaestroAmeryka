...
public class SpAmControllerRest {
    ...
    public String createTableWithHttp() throws IOException, InterruptedException {
...
//        staraListaSpolek = ((List<AmerykaSpolka>) amSpRepository.findAll());
...
//        czytanieDanychJsoup.run(listaTicker);
        ...
        spAmRepository.saveAll(nowaListaSpolek);
        log.info(ANSI_BLUE + " Zrobiłem !!! Odczyt danych z pliku pobranego z HTTP !!!" + ANSI_RESET);
